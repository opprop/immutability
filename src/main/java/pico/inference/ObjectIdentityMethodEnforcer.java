...
public class ObjectIdentityMethodEnforcer extends TreePathScanner<Void, Void> {
    ...
    private PICOInferenceRealTypeFactory typeFactory;
    private BaseTypeChecker checker;

    private ObjectIdentityMethodEnforcer(PICOInferenceRealTypeFactory typeFactory, BaseTypeChecker checker) {
        this.typeFactory = typeFactory;
        this.checker = checker;
    }

    // Main entry
    public static void check(TreePath statement, PICOInferenceRealTypeFactory typeFactory, BaseTypeChecker checker) {
    ...
    private boolean isInAbstractState(Element elt, PICOInferenceRealTypeFactory typeFactory) {
        boolean in = true;
